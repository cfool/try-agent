...
### 🛠️ 实战开发
*   [**第 1 阶段：让 AI 开口说话 (Hello AI)**](docs/01-hello-ai.md) - 第一次调用 LLM API，体验不同的系统提示词 (Persona)。
...
### 🚀 进阶架构
*   [**第 5 阶段：上下文管理 (Context Management)**](docs/05-context-management.md) - 摘要压缩、工具输出截断，解决 Token 限制问题。
