import { Content, Part, GeminiClient } from "./gemini-client.js";
 ...
 */
function truncateHistoryToBudget(history: Content[]): Content[] {
...
export class ChatCompressService {
  ...
  async compressIfNeeded(history: Content[]): Promise<CompressionResult> {
